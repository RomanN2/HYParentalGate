#
#  Be sure to run `pod spec lint HYParentalGate.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "1.0.0"
  s.summary      = "A simple Parental Gate control that might be used in the kids apps in order to protect adult's content, e.g. in app purchases."
...
parental,gate,protect,content
  ...
  # s.license      = { :type => "MIT", :file => "https://github.com/RomanN2/HYParentalGate/blob/master/LICENSE" }
  ...
  s.source       = { :git => "https://github.com/RomanN2/HYParentalGate.git", :tag => "#{s.version}" }
